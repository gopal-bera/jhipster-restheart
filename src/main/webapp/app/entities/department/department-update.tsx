...
export const DepartmentUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...departmentEntity,
          students: departmentEntity?.students?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRestApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Location" id="department-location" name="location" data-cy="location" type="text" />
              <ValidatedField label="University" id="department-university" name="university" data-cy="university" type="text" />
              <ValidatedField label="Student" id="department-student" data-cy="student" type="select" multiple name="students">
                <option value="" key="0" />
                {students
